...
struct OnboardingView: View {
    ...
    private var locationPage: some View {
        page(
            ...
            subtitle: "Con il tuo permesso, Schei riconosce il negozio in cui ti trovi quando apri una nuova spesa: compila l'esercente e sceglie la categoria dal tipo di posto."
        ) {
            VStack(spacing: 12) {
                if locationService.isAuthorized {
                    ...
                    Text("Hai negato l'accesso. Puoi cambiarlo in Impostazioni iOS › Schei › Posizione.")
                        .font(.caption)
                        .foregroundStyle(.secondary)
    ...
    private var obsidianPage: some View {
        page(
            ...
            subtitle: "Scegli la cartella del tuo vault Obsidian. Schei scriverà le spese come normali file Markdown, che puoi leggere e modificare ovunque."
        ) {
            VStack(spacing: 12) {
