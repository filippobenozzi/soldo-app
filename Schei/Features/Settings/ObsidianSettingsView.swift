...
struct ObsidianSettingsView: View {
            ...
            Section {
                ...
                if case .failure(let message) = coordinator.status {
                    Label(message, systemImage: "exclamationmark.triangle.fill")
                        .font(.caption)
                        .foregroundStyle(ScheiTheme.danger)
                }
    ...
    private var vaultSection: some View {
        Section {
                ...
                HStack(spacing: 12) {
                    ...
                    if let accessCheck {
                        Image(systemName: accessCheck ? "checkmark.circle.fill" : "xmark.octagon.fill")
                            .foregroundStyle(accessCheck ? ScheiTheme.ink : ScheiTheme.danger)
                    }
                }
            ...
            Text("Un vault Obsidian è una normale cartella. Scegli quella del vault — in iCloud Drive, dentro «Obsidian» in Su iPhone, o dove preferisci. Schei scrive solo nella sottocartella che indichi qui sotto.")
        }
    }
    ...
    private var modeOptionsSection: some View {
        ...
        case .dailyNote:
            Section {
                ...
                Text("Usa lo stesso formato del plugin Daily Notes di Obsidian (per esempio yyyy-MM-dd). Schei aggiunge una riga sotto il titolo indicato, creando la nota se non esiste.")
            }
        }
    }
    ...
    private func verifyAccess() {
        ...
        case .success:
            accessCheck = true
            alert = InfoAlert(title: "Accesso OK", message: "Schei può leggere e scrivere nel vault.")
