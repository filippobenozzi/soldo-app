        ...
        NavigationStack {
            Form {
                Section {
                        ...
                        HStack(spacing: 12) {
                            ...
                            VStack(alignment: .leading, spacing: 2) {
                                ...
                                Text(vault.isConnected ? (vault.displayName ?? "Vault collegato") : "Non collegato")
                                    .font(.caption)
                                    .foregroundStyle(vault.isConnected ? ScheiTheme.ink : .secondary)
                            }
                        }
                    }
                } header: {
                    ...
                    Text("Schei scrive le spese direttamente nei file del tuo vault. Nessun account, nessun server.")
                }
                ...
                Section {
                    ...
                    Text("Quando apri una nuova spesa, Schei cerca il negozio in cui ti trovi, lo propone come esercente e sceglie la categoria dal tipo di posto. La posizione viene letta solo in quel momento, resta sul dispositivo e finisce nel vault insieme alla spesa.")
                }
                ...
                Section {
                    ...
                    Text("Schei è pensato in bianco e nero. Attiva questa opzione per vedere categorie e conti con il colore che hai scelto per ciascuno.")
                }
