...
/// Explains the automations Soldo exposes — the same ones SyncSpend built around
        ...
        List {
            Section {
                ...
                helpRow(
                    ...
                    detail: "Apre Soldo direttamente sulla schermata di inserimento, con i campi già compilati."
                )
                helpRow(
            ...
            Section {
                ...
                step(3, "Aggiungi l'azione «Aggiungi spesa» di Soldo.")
